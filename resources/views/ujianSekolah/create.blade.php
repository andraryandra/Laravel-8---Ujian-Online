...
@if ('/ujianSekolah-create-'.$DisujianKelases->id && $DisujianKelases->status == 1 && $DisujianKelases->id_kelas == '7' && Auth::user()->kelas->name_kelas >= '7-A' && Auth::user()->kelas->name_kelas <= '7-Z')
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
            ...
            @if($DisujianKelases->id_category == $posts->id_category )
                        ...
                        <div class="m-3">
                            <p class="card-text fs-5">{{ $posts->soal_ujian }}</p>
                        </div>
