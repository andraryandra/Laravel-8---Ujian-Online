...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    ...
    <body class="antialiased">
        <nav class="navbar navbar-dark bg-primary navbar-expand-lg navbar-light mb-3">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    @auth
                  <li class="nav-item">
                    <a href="{{ url('/home') }}" class="nav-link text-white fs-5">Home</a>
                    @else
                    <a href="{{ route('login') }}" class="nav-link text-white fs-5">Log in</a>
                  </li>
                  <li class="nav-item">
                    @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="nav-link text-white fs-5">Register</a>
                  </li>
                  @endif
                    @endauth
                </ul>
