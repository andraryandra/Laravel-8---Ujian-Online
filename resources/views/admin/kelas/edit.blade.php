             ...
             <div class="card-body">
                <form action="/kelas/update" method="post">
                    @csrf
                        ...
                        @else
                        <div class="m-3">
                            <label for="id_wali" class="pb-2 fw-bold">{{ __('Wali Kelas') }}</label>
                            <input type="text" class="form-control" placeholder="Wali Kelas" name="id_wali" value="{{ $kelas->id_wali }}">
                        </div>   
                        @endif
                          
                        <div class="m-3">
                            <label for="name_kelas" class="pb-2 fw-bold">{{ __('Name Kelas') }}</label>
                            <input type="text" class="form-control" placeholder="Name Kelas" name="name_kelas" value="{{ $kelas->name_kelas }}" required>
                        </div>  
                        <div class="m-3">
