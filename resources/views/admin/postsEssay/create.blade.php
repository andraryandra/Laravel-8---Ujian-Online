        ...
        <div class="modal-body">
            <form action="/post-essay/store" method="post">
                ...
                <div class="m-3">
                    ...
                    <textarea name="soal_ujian_essay" id="soal_ujian_essay" cols="5" rows="5" placeholder="Isi Text Soal Essay Ujian..." class="form-control" required >{{ old('soal_ujian_essay') }}</textarea>
                </div><br>
