                            ...
                            <div class="col">
                                <div class="progress progress-sm mr-2">
                                    <div class="progress-bar bg-info" role="progressbar"
                                        style="width: {{ $categoryUjiansCount }}%" aria-valuenow="50" aria-valuemin="0"
                ...
                <div class="table-responsive ">
                    <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                        @endphp
                        @foreach ($categoryUjians as $categoryUjian)
                        <tr id="tr_{{ $categoryUjian->id }}">
                            <td class="text-center">
                                <input type="checkbox" class="sub_chk" data-id="{{ $categoryUjian->id }}">
                            </td>
